...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onLocationChanged(Location location) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("User Location").child(uid);
        DatabaseReference timestamp = reference.child("timestamp");
        reference.setValue(send).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
